...
def pagina_1():
    ...
    st.write("Este es un proyecto sobre Modelos ML")
    st.write("Aprendizaje Supervisado")
    st.write("")
    st.write("Tenemos 2 ejemplos de modelos ML")
...
def pagina_2():
    ...
    with open('rLog(internet).pkl', 'rb') as f:
        ...
        if st.button("RESULTADO"):
           st.write('El resultado del modelo es :', prediccion )
           if prediccion == 0:
               st.write("No usa Internet.")
           else:  
               st.write("Si usa internet. ")
...
def pagina_3():
    ...
    with open('baye(especialista).pkl', 'rb') as f:
        ...
        if st.button("RESULTADO"):
           st.write('El resultado del modelo es :', prediccion )
           if prediccion == 0:
               st.write("No tiene especialistas en TIC's ")
           else:  
               st.write("Si tiene especialistas en TIC's . ")
...
st.sidebar.write("")
st.sidebar.markdown("---")
st.sidebar.write("@ C. Flores - J. Lescano")
